                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('tickets.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" rows="4" required placeholder="Jelaskan kendala secara rinci..." class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"></textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <select name="priority" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                                    ...
                                    <option value="Medium" selected>Sedang (Mengganggu kerja)</option>
                        ...
                        <div class="flex justify-end">
                            <a href="{{ route('dashboard') }}" class="px-4 py-2 bg-gray-300 text-gray-800 rounded-md mr-2 hover:bg-gray-400">Batal</a>
                            <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Buat Tiket</button>
                        </div>
                    </form>
                </div>
            </div>
